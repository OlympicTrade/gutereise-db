...
return [
    ...
    'view_helpers' => [
        'invokables' => [
            ...
            /*'menu'              => AppVHelper\Menu::class,
            'generateMeta'      => View\Helper\GenerateMeta::class,
            'shortTable'        => PVHelper\ShortTable::class,
            'smartList'         => PVHelper\SmartList::class,
            'link'              => PVHelper\Link::class,
            'sidebar'           => PVHelper\Sidebar::class,
            'join'              => PVHelper\Join::class,
            'declension'        => PVHelper\Declension::class,
            'subStr'            => PVHelper\SubStr::class,
            'price'             => PVHelper\Price::class,
            'date'              => PVHelper\Date::class,
            'viewRowset'        => PVHelper\ViewRowset::class,
            'tableList'         => PVHelper\TableList::class,
            'breadcrumbs'       => PVHelper\Breadcrumbs::class,
            'requisites'        => PVHelper\Requisites::class,
            'htmlElement'       => PVHelper\HtmlElement::class,
            'requisitesView'    => PVHelper\RequisitesView::class,
            'commonElements'    => PVHelper\CommonElements::class,
            'contacts'          => PVHelper\Contacts::class,
            'formelement'       => PFVHelper\FormElement::class,
            'eCheckbox'         => PFVHelper\ECheckbox::class,
            'eCollection'       => PFVHelper\ECollection::class,
            'formlistselect'    => PFVHelper\FormListSelect::class,
            'formAutocomplete'  => PFVHelper\FormAutocomplete::class,
            'formRow'           => PFVHelper\FormRow::class,
            'formRowset'        => PFVHelper\FormRowset::class,
            'formCollection'    => PFVHelper\FormCollection::class,
            'formTreeSelect'    => PFVHelper\FormTreeSelect::class,
            'eCompanyDetails'   => PFVHelper\ECompanyDetails::class,*/
        ],
    ],
    'router' => [
        'routes' => [
